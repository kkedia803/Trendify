...
import { menbt, womenbt } from '../content/Beauty';
  ...
  return (
    <div className='pb-5'>
      <div className="relative">
        ...
        {/* MEN */}
        <div className='mx-10 my-5'>
          <h2 className='text-xl font-semibold '>Men Grooming Products</h2>
        </div>
        ...
        {/* WOMEN  */}
        <div className='mx-10 my-5'>
          <h2 className='text-xl font-semibold '>Women Beauty Products</h2>
        </div>
